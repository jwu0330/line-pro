...
function generateInstallCommand(extensionId) {
    ...
    cmd += '}\n';
    cmd += '"@\n';
    cmd += '                $lineWindows = New-Object System.Collections.ArrayList\n';
    cmd += '                $callback = {\n';
    ...
    cmd += '                        $lineWindows.Add($hwnd) | Out-Null\n';
    cmd += '                    }\n';
    cmd += '                    return $true\n';
    cmd += '                }\n';
    cmd += '                [WindowHelper]::EnumWindows($callback, [IntPtr]::Zero)\n';
    cmd += '                foreach ($hwnd in $lineWindows) {\n';
    cmd += '                    [WindowHelper]::PostMessage($hwnd, [WindowHelper]::WM_CLOSE, [IntPtr]::Zero, [IntPtr]::Zero) | Out-Null\n';
    cmd += '                }\n';
    cmd += '                break\n';
    cmd += '            }\n';
    cmd += '            Start-Sleep -Seconds 2\n';
